...
import styles from "./animateFonts.less";
...
export default class AnimateImg extends Component {
    handleAnimateDataChange = async payload => {
        ...
        const { animate = {}, type, fontFamily, renderSetting, uuid } = this.props.data;
        ...
        if (payload.animationName && type !== CANVAS_TYPE.animateFont) {
            if (limitInsert(null, CANVAS_TYPE.animateFont) === false) return;
        }
        ...
        const newFontFamily = SUBTITLES_FONTS[fontFamily]
            ? fontFamily
            : DEFAULT_ANIMATE_FONT_FAMILY;
    ...
    previewAnimate = () => {
        ...
        const {
            animate = {},
            renderSetting: { startTime = 0, endTime }
        } = this.props.data;
            ...
            <div className={styles.animate_font__set}>
                ...
                <Drawer
                    ...
                    <div className={styles.typesContainer}>
                        ...
                        {/*onClick={() => this.handleAnimateDataChange({*/}
                        {/*animationName: undefined,*/}
                        {/*animationDuration: 0,*/}
                        {/*animationIteration: 0,*/}
                        {/*stageType: activeTab,*/}
