...
class videoOption extends React.PureComponent {
    constructor(props) {
        ...
        this.state = {
            ...
            coverImg: flash.coverImg,
            nowAspectRatio: null,
            systemTailLeaderOn: flash.systemTailLeaderOn,
            hoz: flash.transverse ? 'hoz' : 'vet',
            saving: false,
    ...
    componentDidMount() {
        ...
        getSystemTailLeader(this.props.flash.transverse)
            .then(({ data }) => {
                if (data.success) {
    ...
    shareSetParamsToModal = (shareSet) => {
        this.props.dispatch({
            type: 'flash/shareSetParamsToModal',
            payload: shareSet,
        });
    }
    ...
    render() {
        ...
        const { flash: { transverse = true } = {} } = props;
        ...
        return (
            <div className={styles.body}>
                ...
                <Modal visible={this.state.chatSetVisible} onCancel={this.chatSetClose}>
                    <ShareSet videoId={this.props.flash.worksId}
